...
export default function ImageProcessingPage() {
  ...
  const categoryAgents = agents.filter((a) => a.category === 'image_processing');
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Edit, enhance, and analyze images with advanced AI capabilities.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-gray-600 dark:text-gray-400">
          <p>No image processing agents available yet.</p>
        </div>
      )}
    </div>
  );
