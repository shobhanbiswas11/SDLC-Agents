...
export default function DataAnalysisPage() {
  ...
  const categoryAgents = agents.filter((a) => a.category === 'data_analysis');
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Analyze, visualize, and extract insights from data with powerful AI agents.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-gray-600 dark:text-gray-400">
          <p>No data analysis agents available yet.</p>
        </div>
      )}
    </div>
  );
