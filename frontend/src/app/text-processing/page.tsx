...
export default function TextProcessingPage() {
  ...
  const categoryAgents = agents.filter((a) => a.category === 'text_processing');
    ...
    <div className="space-y-8">
      <div>
        ...
        <p className="text-gray-600 dark:text-gray-400">
          Process, analyze, and transform text data with specialized AI agents.
        </p>
      </div>
      ...
      {isLoading ? (
        ...
        <div className="text-center py-12 text-gray-600 dark:text-gray-400">
          <p>No text processing agents available yet.</p>
        </div>
      )}
    </div>
  );
