...
# ─────────────────────────────────────────────────────────────
# Language-aware standards reference for the AI agent
# ─────────────────────────────────────────────────────────────
...
def _get_language_context(language: str) -> str:
    """Build a context string for the given language standards."""
    lang = LANGUAGE_STANDARDS.get(language.lower(), None)
    if not lang:
        return f"Analyze the code for general coding standard violations."
...
# ─────────────────────────────────────────────────────────────
# Agent Analysis Prompt — identifies violations autonomously
# ─────────────────────────────────────────────────────────────
...
# ─────────────────────────────────────────────────────────────
# Agent Fix Prompt — generates full fixed code
# ─────────────────────────────────────────────────────────────

fix_all_prompt = PromptTemplate(
    input_variables=["language", "language_context", "code", "violations_summary"],
    template="""You are an expert {language} engineer. Fix ALL the coding standard violations listed below in the provided code.
...
- Preserve the original logic — only fix style, naming, and standard violations.
- Do NOT add new functionality or change behavior.
- Return the COMPLETE fixed code.

Respond in exactly this format:

Explanation:
A brief summary of all changes made.

Fixed Code:
<the complete fixed code with no markdown fencing>
""",
)


def get_language_context(language: str) -> str:
    """Public accessor for language context."""
    return _get_language_context(language)
...
def get_language_info(language: str) -> Optional[dict]:
    """Return language info dict or None."""
