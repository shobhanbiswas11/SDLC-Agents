...
from app.agent.tools.project_generator import generate_project_blueprint


def generate_project(spec: Spec):
    blueprint = generate_project_blueprint(spec)

    return {
        "status": "complete",
        "tree": blueprint["tree"],
        "files": blueprint["files"],
        "init_instructions": blueprint["init_instructions"],
    }
