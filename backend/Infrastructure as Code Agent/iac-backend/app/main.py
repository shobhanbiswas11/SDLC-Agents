...
def build_context_prompt(prompt: str, conversation_history: List[Message]) -> str:
    if not conversation_history:
        ...
        4. In your Final Answer, include the generated code and then include the COMPLETE output from check_policies EXACTLY as it was returned — do NOT rephrase, summarize, or reformat it. Preserve the exact STATUS, VIOLATIONS, WARNINGS, and LLM Analysis sections.
    ...
    return f"""
        ...
        4. In your Final Answer, include the generated/modified code and then include the COMPLETE output from check_policies EXACTLY as it was returned — do NOT rephrase, summarize, or reformat it. Preserve the exact STATUS, VIOLATIONS, WARNINGS, and LLM Analysis sections.
